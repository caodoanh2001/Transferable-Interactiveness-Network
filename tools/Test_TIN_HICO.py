...
if __name__ == '__main__':
    ...
    temp_Test_RCNN = pickle._Unpickler(open( cfg.DATA_DIR + '/' + 'Test_Faster_RCNN_R-50-PFN_2x_HICO_DET_with_pose.pkl', "rb" ))
    temp_Test_RCNN.encoding = 'latin1'
    Test_RCNN = temp_Test_RCNN.load()
