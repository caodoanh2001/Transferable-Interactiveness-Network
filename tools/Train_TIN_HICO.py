...
if __name__ == '__main__':
    ...
    temp_Trainval_GT = pickle._Unpickler(open( cfg.DATA_DIR + '/' + 'Trainval_GT_HICO_with_pose.pkl', "rb" ))
    temp_Trainval_GT.encoding = 'latin1'
    Trainval_GT = temp_Trainval_GT.load()

    temp_Trainval_N = pickle._Unpickler(open( cfg.DATA_DIR + '/' + 'Trainval_Neg_HICO_with_pose.pkl', "rb" ))
    temp_Trainval_N.encoding = 'latin1'
    Trainval_N = temp_Trainval_N.load()
